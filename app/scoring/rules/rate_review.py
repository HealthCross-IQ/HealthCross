...
SEED_DECISIONS: List[dict] = [
    ...
    {"product": "Silver", "network_scope": "all", "network": None, "from_age": 18, "to_age": 25, "gender": None,
     "action": "discount", "change_pct": -10.0, "note": "18-25 at 55% gross both sexes (43 lives, thin) - room to compete."},
    {"product": "Silver", "network_scope": "all", "network": None, "from_age": 26, "to_age": 35, "gender": "M",
     "action": "discount", "change_pct": -10.0, "note": "Males 26-35 at 61% gross (163 lives, fully credible)."},
    {"product": "Silver", "network_scope": "all", "network": None, "from_age": 26, "to_age": 35, "gender": "F",
